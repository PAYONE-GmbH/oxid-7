        ...
        <div>
            ...
            <dl>
                ...
                <dd style="margin-top: 4px; margin-left: 150px;">
                    ...
                    <input type="button" onclick="JavaScript:showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=V&amp;type=cc');" class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
            ...
            <dl>
                ...
                <dd style="margin-top: 4px; margin-left: 150px;">
                    ...
                    <input type="button" onclick="JavaScript:showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=M&amp;type=cc');" class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
                    [{oxinputhelp ident="FCPO_HELP_ASSIGNCOUNTRIES"}]
            ...
            <dl>
                ...
                <dd style="margin-top: 4px; margin-left: 150px;">
                    ...
                    <input type="button" onclick="JavaScript:showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=A&amp;type=cc');" class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
                    [{oxinputhelp ident="FCPO_HELP_ASSIGNCOUNTRIES"}]
            ...
            <dl>
                ...
                <dd style="margin-top: 4px; margin-left: 150px;">
                    ...
                    <input type="button" onclick="JavaScript:showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=D&amp;type=cc');" class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
                    [{oxinputhelp ident="FCPO_HELP_ASSIGNCOUNTRIES"}]
            ...
            <dl>
                ...
                <dd style="margin-top: 4px; margin-left: 150px;">
                    ...
                    <input type="button" onclick="JavaScript:showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=J&amp;type=cc');" class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
                    [{oxinputhelp ident="FCPO_HELP_ASSIGNCOUNTRIES"}]
            ...
            <dl>
                ...
                <dd style="margin-top: 4px; margin-left: 150px;">
                    ...
                    <input type="button" onclick="JavaScript:showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=O&amp;type=cc');" class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
                    [{oxinputhelp ident="FCPO_HELP_ASSIGNCOUNTRIES"}]
            ...
            <dl>
                ...
                <dd style="margin-top: 4px; margin-left: 150px;">
                    ...
                    <input type="button" onclick="JavaScript:showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=U&amp;type=cc');" class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
                    [{oxinputhelp ident="FCPO_HELP_ASSIGNCOUNTRIES"}]
            ...
            <dl>
                ...
                <input type="button" onclick="JavaScript:showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=B&amp;type=cc');" class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
                [{oxinputhelp ident="FCPO_HELP_ASSIGNCOUNTRIES"}]
        ...
        <div[{if $oView->fcpoIsStoreIdAdded()}] class="exp"[{/if}]>
            ...
            [{foreach from=$oView->fcpoGetStoreIds() item=sStoreId key=sKey}]
                <dl>
                    ...
                    <dd>
                        StoreID
                        <input type="button" onclick="JavaScript:showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=KLV&amp;type=[{$sKey}]');" class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
                    ...
                    <dd>
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="button" onclick="JavaScript:showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=KLR_[{$sId}]&amp;type=[{$sKey}]');" class="" value="[{oxmultilang ident="FCPO_ASSIGN_COUNTRIES"}]">
                                </td>
                            </tr>
                            <tr>
