...
$aLang = [
    ...
    'FCPO_APPROVALTEXT' => "Hinweistext Zustimmung Bonitätsprüfung",
    ...
    'fcpo_admin_config_delete_confirm' => "Möchten Sie diesen Eintrag wirklich löschen?",
    ...
    'FCPO_KLARNA_ADD_CAMPAIGN' => "weitere Kampagne hinzufügen",
    ...
    'FCPO_ASSIGN_COUNTRIES' => "Länder zuordnen",
    'FCPO_COUNTRIES' => "Länder",
    'FCPO_LANGUAGE' => "Sprache",
    'FCPO_CURRENCY' => "Währung",
    'FCPO_HELP_KLARNA_CAMPAIGNS' => "Die Bestellungen werden bei Klarna nur akzeptiert, wenn die Kombination aus Land, Sprache und Währung zusammen passt.<br>Sie müssen diese Kombinationen hier auch hinterlegen und der Kunde bekommt dann nur die passenden Kampagnen angezeigt.",
    ...
    'FCPO_PREVIEW_NOTICE' => 'änderungen sind in der Vorschau erst nach dem Speichern sichtbar!',
    ...
    'FCPO_MALUS' => 'Abzug',
    'FCPO_MALUS_PPB' => 'Person kann für diese Adresse bestätigt werden',
    ...
    'FCPO_HELP_MALUS' => 'Die konfigurierten Abzüge werden entsprechend dem Rückgabewert der Adressprüfung vom Bonitäts-Wert des Kunden abgezogen. Der Bonitäts-Wert kann 0 hierbei nicht unterschreiten.',
