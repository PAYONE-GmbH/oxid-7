...
$aLang = [
    ...
    'FCPO_HELP_SUBACCOUNTID' => 'Please enter the ID of the Sub-Account, which will be processed through the payments and allocated.<br>The ID can be found at <a href = "http://www.payone.de" target = "_blank">http://www.payone.de</a> > Merchant Login in the menu Settings > Accounts <br><br>All relevant parameters for configuration, please visit <a href="http://www.payone.de" target="_blank">http://www.payone.de</a> > Merchant Login in the menu configuration > Payment portals > [edit] > tab [API parameters]',
