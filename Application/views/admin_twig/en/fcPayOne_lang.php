...
$aLang = [
    ...
    'FCPO_HELP_PORTALID' => 'Please enter PAYONE Portal-ID which is used to complete payments.<br>You will find your Portal-ID at <a href="https://www.payone.de" target="_blank">https://www.payone.de</a> > Merchant-Login at menu entry Configuration > Payment Portals<br><br>You will get all relevant configuration parameters [edit] under tab [API-Parameter]',
    'FCPO_HELP_PORTALKEY' => 'Please enter the Key that is used for secure transaction . This can be freely configured by you in PAYONE Portal interface.<br>You can find this configuration at <a href="https://www.payone.de" target="_blank">https://www.payone.de</a> > Merchant-Login at menu entry Configuration > Payment Portals > [editieren] > Reiter [Erweitert] > Key<br><br>You will get all relevant configuration parameters under tab [API-Parameter]',
    ...
    'FCPO_HELP_SUBACCOUNTID' => 'Please enter the ID of the Sub-Account, which will be processed through the payments and allocated.<br>The ID can be found at <a href = "https://www.payone.de" target = "_blank">https://www.payone.de</a> > Merchant Login in the menu Settings > Accounts <br><br>All relevant parameters for configuration, please visit <a href="https://www.payone.de" target="_blank">https://www.payone.de</a> > Merchant Login in the menu configuration > Payment portals > [edit] > tab [API parameters]',
    ...
    'FCPO_MAIN_CONFIG_TESTACCOUNT_LINK' => 'Don\'t have a PAYONE Account yet? Click <a href="https://www.payone.com/DE-de/kampagne/ecom-testaccount" target="_blank">here</a> to apply for test credentials.',
