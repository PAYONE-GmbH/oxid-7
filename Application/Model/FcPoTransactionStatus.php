...
final class FcPoTransactionStatus extends BaseModel
{
     ...
     * @var string
     */
    protected $_sClassName = FcPoTransactionStatus::class;
    /** @var array<string, string> */
    private const A_MATCH_MAP = ['V' => 'Visa', 
    'M' => 'Mastercard', 
    'A' => 'Amex', 
    'D' => 'Diners', 
    'J' => 'JCB', 
     ...
     * @return object
     */
    private function _fcpoGetOrderByTxid($sTxid)
    {
    ...
    public function getCardtype()
    {
        ...
        return self::A_MATCH_MAP[$sCardType] ?? $sCardType;
    }
    ...
    {
        $oLang = $this->_oFcpoHelper->fcpoGetLang();
        $sLangAppointed = $this->_fcpoGetLangIdent($dReceivable, 'fcpo_receivable_appointed1', 
    'fcpo_receivable_appointed2');
        $sLangReminder = $this->_fcpoGetLangIdent($dReceivable, 'fcpo_receivable_reminder', 
    '');
        $sLangDebit = $this->_fcpoGetLangIdent($dReceivable, 'fcpo_receivable_debit1', 
    'fcpo_receivable_debit2');

        $aMatchMap = ['cancelation' => 'fcpo_receivable_cancelation', 
    'appointed' => $sLangAppointed, 'capture' => 'fcpo_receivable_capture', 
    'refund' => $sLangDebit, 'debit' => $sLangDebit, 'reminder' => $sLangReminder];
     ...
     * @return string
     */
    private function _fcpoGetLangIdent($dValue, string $sOption1, string $sOption2)
    {
     ...
     * @return string
     */
    private function _fcpoGetMapAction($sTxAction, array $aMatchMap, string $sDefault)
    {
        return $aMatchMap[$sTxAction] ?? $sDefault;
    }
    ...
    public function getDisplayNamePayment($dPayment)
    {
        ...
        $sLangCapture = $this->_fcpoGetLangIdent($dPayment, 'fcpo_payment_capture1', 
    'fcpo_payment_capture2');
        $sLangPaid = $this->_fcpoGetLangIdent($dPayment, 'fcpo_payment_paid1', 
    'fcpo_payment_paid2');
        $sLangUnderpaid = $this->_fcpoGetLangIdent($dPayment, 'fcpo_payment_underpaid1', 
    'fcpo_payment_underpaid2');
        $sLangDebit = $this->_fcpoGetLangIdent($dPayment, 'fcpo_payment_debit1', 
    'fcpo_payment_debit2');
