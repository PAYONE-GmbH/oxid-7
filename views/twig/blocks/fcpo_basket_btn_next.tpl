...
[{if $oViewConf->fcpoCanDisplayPaydirektExpressButton()}]
    [{assign var="sFcPoTemplatePathPaydirektExpress" value=$sFcPoTemplatePath|cat:'/fcpayone_paydirekt_express_button.html.twig'}]
...
[{if $oViewConf->fcpoCanDisplayAmazonPayButton()}]
    [{assign var="sFcPoTemplatePathAmazon" value=$sFcPoTemplatePath|cat:'/fcpayone_amazon_paybutton.html.twig'}]
    [{include
