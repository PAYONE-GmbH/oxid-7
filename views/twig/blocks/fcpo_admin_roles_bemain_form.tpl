<tr>
    ...
    <td>
        <input class="edittext" type="checkbox" name="editval[oxroles__oxactive]" value="1"
               [{if $edit->oxroles__oxactive->value}]checked[{/if}] [{$readonly}]>
...
<tr>
    ...
    <td>
        <input autocomplete="off" class="edittext" type="text" style="width:215px" name="editval[oxroles__oxtitle]"
               maxlength="[{$edit->oxroles__oxtitle->fldmax_length}]" value="[{$edit->oxroles__oxtitle->value}]"
               [{$readonly}]>
            ...
            <table class="edittext rrtable">
                ...
                <tr id="[{$oNode->getAttribute('id')}]">
                    <td>
                        ...
                        [{include file="roles_bemain_inc.html.twig" aNodes=$oNode->childNodes oParent=$oNode iParentIdx=$idx}]
                    ...
                    <td>
                        <input [{$readonly}] type="radio"
                               [{if $oNode->hasAttribute('idx') && $oNode->getAttribute('idx') < 2}]disabled[{/if}]
                               name="aFields[[{$oNode->getAttribute('id')}]]" onclick="setPerms( this );"
                               value="2" [{if $idx == 2}]checked[{/if}]>
                    </td>
                    <td>
                        <input [{$readonly}] type="radio"
                               [{if $oNode->hasAttribute('idx') && $oNode->getAttribute('idx') < 1}]disabled[{/if}]
                               name="aFields[[{$oNode->getAttribute('id')}]]" onclick="setPerms( this );"
                               value="1" [{if $idx == 1}]checked[{/if}]>
                    </td>
                    <td>
                        <input [{$readonly}] type="radio" name="aFields[[{$oNode->getAttribute('id')}]]"
                               onclick="setPerms( this );" value="0" [{if !$idx}]checked[{/if}]>
                    </td>
                    <td>
                        [{if $oNode->childNodes->length}]
                    <input readonly disabled type="checkbox" id="aFields[[{$oNode->getAttribute('id')}]]_cust"
                           value="0">
                ...
                <tr id="dyn_menu">
                    <td>
                        ...
                        <table class="edittext rrtableabs" style="display:none">
                            ...
                            <tr id="dyn_about">
                                ...
                                <td>
                                    <input [{$readonly}] type="radio" [{if $iParentIdx < 2}]disabled[{/if}]
                                           name="aFields[dyn_about]" onclick="setPerms( this );" value="2"
                                           [{if $idx == 2}]checked[{/if}]>
                                </td>
                                <td>
                                    <input [{$readonly}] type="radio" [{if $iParentIdx < 1}]disabled[{/if}]
                                           name="aFields[dyn_about]" onclick="setPerms( this );" value="1"
                                           [{if $idx == 1}]checked[{/if}]>
                                </td>
                                <td>
                    ...
                    <td>
                        <input [{$readonly}] type="radio"
                               [{if isset( $aDynRights.dyn_menu ) && $aDynRights.dyn_menu < 2}]disabled[{/if}]
                               name="aFields[dyn_menu]" onclick="setPerms( this );" value="2"
                               [{if $iParentIdx == 2}]checked[{/if}]>
                    </td>
                    <td>
                        <input [{$readonly}] type="radio"
                               [{if isset( $aDynRights.dyn_menu ) && $aDynRights.dyn_menu < 1}]disabled[{/if}]
                               name="aFields[dyn_menu]" onclick="setPerms( this );" value="1"
                               [{if $iParentIdx == 1}]checked[{/if}]>
                    </td>
                    <td>
                        <input [{$readonly}] type="radio" name="aFields[dyn_menu]"
                               onclick="setPerms( this );" value="0" [{if !$iParentIdx}]checked[{/if}]>
                    </td>
                    <td>
                ...
                <tr id="fcpo_admin_title">
                    ...
                    <td>
                        <input [{$readonly}] type="radio"
                               [{if isset( $aDynRights.fcpo_admin_title ) && $aDynRights.fcpo_admin_title < 2}]disabled[{/if}]
                               name="aFields[fcpo_admin_title]" value="2" [{if $iParentIdx == 2}]checked[{/if}]>
                    </td>
                    <td>
                        <input [{$readonly}] type="radio"
                               [{if isset( $aDynRights.fcpo_admin_title ) && $aDynRights.fcpo_admin_title < 1}]disabled[{/if}]
                               name="aFields[fcpo_admin_title]" value="1" [{if $iParentIdx == 1}]checked[{/if}]>
                    </td>
                    <td>
                        <input [{$readonly}] type="radio" name="aFields[fcpo_admin_title]" value="0"
                               [{if !$iParentIdx}]checked[{/if}]>
                    </td>
                    <td>
                    </td>
                </tr>
