[{include file="headitem.html.twig" title="GENERAL_ADMIN_TITLE"|oxmultilangassign}]
...
<form autocomplete="off" name="myedit" id="myedit" action="[{$oViewConf->getSelfLink()}]" method="post"
    ...
    <div class="groupExp">
        <div>
            <a href="#" onclick="_groupExp(this);return false;"
               class="rc"><b>[{oxmultilang ident="FCPO_CONFIG_GROUP_CONN"}]</b></a>
            <dl>
                <dt>
            ...
            <dl>
                <dt>
                    <input type="text" class="txt" name="confstrs[sFCPOPortalKey]" value="[{$confstrs.sFCPOPortalKey}]"
                           [{$readonly}]>
            ...
            <dl>
                <dt>
                    <input type="text" class="txt" name="confstrs[sFCPORefPrefix]" value="[{$confstrs.sFCPORefPrefix}]"
                           [{$readonly}]>
            ...
            <dl>
                <dt>
                    <select name="confstrs[sFCPOHashMethod]">
                        ...
                        <option value="sha2-384" [{if $confstrs.sFCPOHashMethod == "sha2-384"}]SELECTED[{/if}]>sha2-384
                            (empfohlen)
                        </option>
                    </select>
    ...
    <div class="groupExp">
        <div>
            <a href="#" onclick="_groupExp(this);return false;"
               class="rc"><b>[{oxmultilang ident="FCPO_CONFIG_GROUP_GENERAL"}]</b></a>
            <dl>
                <dt>
                    ...
                    <input type="checkbox" name="confbools[blFCPOSendArticlelist]" value="true"
                           [{if ($confbools.blFCPOSendArticlelist)}]checked[{/if}]>
            ...
            <dl>
                <dt>
                    ...
                    <input type="checkbox" name="confbools[blFCPOPresaveOrder]" value="true"
                           [{if ($confbools.blFCPOPresaveOrder)}]checked[{/if}]
                           onclick="handlePresaveOrderCheckbox(this);">
            ...
            <dl id="reduce_stock" [{if !($confbools.blFCPOPresaveOrder)}]style="display: none;" [{/if}]>
                ...
                <dd>
                    ...
                    <input type="radio" name="confbools[blFCPOReduceStock]" value="0"
                           [{if $confbools.blFCPOReduceStock == '0' || !$confbools.blFCPOReduceStock}]checked[{/if}]>
                    [{oxmultilang ident="FCPO_REDUCE_STOCK_BEFORE"}]<br>
                    <input type="radio" name="confbools[blFCPOReduceStock]" value="1"
                           [{if $confbools.blFCPOReduceStock == '1'}]checked[{/if}]>
                    [{oxmultilang ident="FCPO_REDUCE_STOCK_AFTER"}]
                </dd>
                <div class="spacer"></div>
            </dl>
        </div>
    ...
    <div class="groupExp">
        <div>
            <a href="#" onclick="_groupExp(this);return false;"
               class="rc"><b>[{oxmultilang ident="FCPO_ACTIVE_CREDITCARD_TYPES"}]</b></a>
            <dl>
                <dt></dt>
                <dd>
            ...
            <dl>
                ...
                <dd style="margin-top: 4px; margin-left: 150px;">
                    ...
                    <input type="checkbox" name="confbools[blFCPOVisaActivated]" value="true"
                           [{if ($confbools.blFCPOVisaActivated)}]checked[{/if}]>
                    <input type="button"
                           onclick="showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=V&amp;type=cc');"
                           class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
                    [{oxinputhelp ident="FCPO_HELP_ASSIGNCOUNTRIES"}]
                    <input type="radio" name="confbools[blFCPOCCVLive]" value="1"
                           [{if $confbools.blFCPOCCVLive == '1'}]checked[{/if}]> <strong>Live</strong>
                    <input type="radio" name="confbools[blFCPOCCVLive]" value="0"
                           [{if $confbools.blFCPOCCVLive == '0' || !$confbools.blFCPOCCVLive}]checked[{/if}]> Test
                </dd>
                <div class="spacer"></div>
            </dl>
            <dl>
                ...
                <dd style="margin-top: 4px; margin-left: 150px;">
                    ...
                    <input type="checkbox" name="confbools[blFCPOMastercardActivated]" value="true"
                           [{if ($confbools.blFCPOMastercardActivated)}]checked[{/if}]>
                    <input type="button"
                           onclick="showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=M&amp;type=cc');"
                           class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
                    [{oxinputhelp ident="FCPO_HELP_ASSIGNCOUNTRIES"}]
                    <input type="radio" name="confbools[blFCPOCCMLive]" value="1"
                           [{if $confbools.blFCPOCCMLive == '1'}]checked[{/if}]> <strong>Live</strong>
                    <input type="radio" name="confbools[blFCPOCCMLive]" value="0"
                           [{if $confbools.blFCPOCCMLive == '0' || !$confbools.blFCPOCCMLive}]checked[{/if}]> Test
                </dd>
                <div class="spacer"></div>
            </dl>
            <dl>
                ...
                <dd style="margin-top: 4px; margin-left: 150px;">
                    ...
                    <input type="checkbox" name="confbools[blFCPOAmexActivated]" value="true"
                           [{if ($confbools.blFCPOAmexActivated)}]checked[{/if}]>
                    <input type="button"
                           onclick="showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=A&amp;type=cc');"
                           class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
                    [{oxinputhelp ident="FCPO_HELP_ASSIGNCOUNTRIES"}]
                    <input type="radio" name="confbools[blFCPOCCALive]" value="1"
                           [{if $confbools.blFCPOCCALive == '1'}]checked[{/if}]> <strong>Live</strong>
                    <input type="radio" name="confbools[blFCPOCCALive]" value="0"
                           [{if $confbools.blFCPOCCALive == '0' || !$confbools.blFCPOCCALive}]checked[{/if}]> Test
                </dd>
                <div class="spacer"></div>
            </dl>
            <dl>
                ...
                <dd style="margin-top: 4px; margin-left: 150px;">
                    ...
                    <input type="checkbox" name="confbools[blFCPODinersActivated]" value="true"
                           [{if ($confbools.blFCPODinersActivated)}]checked[{/if}]>
                    <input type="button"
                           onclick="showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=D&amp;type=cc');"
                           class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
                    [{oxinputhelp ident="FCPO_HELP_ASSIGNCOUNTRIES"}]
                    <input type="radio" name="confbools[blFCPOCCDLive]" value="1"
                           [{if $confbools.blFCPOCCDLive == '1'}]checked[{/if}]> <strong>Live</strong>
                    <input type="radio" name="confbools[blFCPOCCDLive]" value="0"
                           [{if $confbools.blFCPOCCDLive == '0' || !$confbools.blFCPOCCDLive}]checked[{/if}]> Test
                </dd>
                <div class="spacer"></div>
            </dl>
            <dl>
                ...
                <dd style="margin-top: 4px; margin-left: 150px;">
                    ...
                    <input type="checkbox" name="confbools[blFCPOJCBActivated]" value="true"
                           [{if ($confbools.blFCPOJCBActivated)}]checked[{/if}]>
                    <input type="button"
                           onclick="showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=J&amp;type=cc');"
                           class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
                    [{oxinputhelp ident="FCPO_HELP_ASSIGNCOUNTRIES"}]
                    <input type="radio" name="confbools[blFCPOCCJLive]" value="1"
                           [{if $confbools.blFCPOCCJLive == '1'}]checked[{/if}]> <strong>Live</strong>
                    <input type="radio" name="confbools[blFCPOCCJLive]" value="0"
                           [{if $confbools.blFCPOCCJLive == '0' || !$confbools.blFCPOCCJLive}]checked[{/if}]> Test
                </dd>
                <div class="spacer"></div>
            </dl>
            <dl>
                ...
                <dd style="margin-top: 4px; margin-left: 150px;">
                    ...
                    <input type="checkbox" name="confbools[blFCPOMaestroIntActivated]" value="true"
                           [{if ($confbools.blFCPOMaestroIntActivated)}]checked[{/if}]>
                    <input type="button"
                           onclick="showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=O&amp;type=cc');"
                           class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
                    [{oxinputhelp ident="FCPO_HELP_ASSIGNCOUNTRIES"}]
                    <input type="radio" name="confbools[blFCPOCCOLive]" value="1"
                           [{if $confbools.blFCPOCCOLive == '1'}]checked[{/if}]> <strong>Live</strong>
                    <input type="radio" name="confbools[blFCPOCCOLive]" value="0"
                           [{if $confbools.blFCPOCCOLive == '0' || !$confbools.blFCPOCCOLive}]checked[{/if}]> Test
                </dd>
                <div class="spacer"></div>
            </dl>
            <dl>
                ...
                <dd style="margin-top: 4px; margin-left: 150px;">
                    ...
                    <input type="checkbox" name="confbools[blFCPOMaestroUKActivated]" value="true"
                           [{if ($confbools.blFCPOMaestroUKActivated)}]checked[{/if}]>
                    <input type="button"
                           onclick="showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=U&amp;type=cc');"
                           class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
                    [{oxinputhelp ident="FCPO_HELP_ASSIGNCOUNTRIES"}]
                    <input type="radio" name="confbools[blFCPOCCULive]" value="1"
                           [{if $confbools.blFCPOCCULive == '1'}]checked[{/if}]> <strong>Live</strong>
                    <input type="radio" name="confbools[blFCPOCCULive]" value="0"
                           [{if $confbools.blFCPOCCULive == '0' || !$confbools.blFCPOCCULive}]checked[{/if}]> Test
                </dd>
                <div class="spacer"></div>
            </dl>
            <dl>
                ...
                <dd style="margin-top: 4px; margin-left: 150px;">
                    ...
                    <input type="checkbox" name="confbools[blFCPOCarteBleueActivated]" value="true"
                           [{if ($confbools.blFCPOCarteBleueActivated)}]checked[{/if}]>
                    <input type="button"
                           onclick="showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=B&amp;type=cc');"
                           class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
                    [{oxinputhelp ident="FCPO_HELP_ASSIGNCOUNTRIES"}]
                    <input type="radio" name="confbools[blFCPOCCBLive]" value="1"
                           [{if $confbools.blFCPOCCBLive == '1'}]checked[{/if}]> <strong>Live</strong>
                    <input type="radio" name="confbools[blFCPOCCBLive]" value="0"
                           [{if $confbools.blFCPOCCBLive == '0' || !$confbools.blFCPOCCBLive}]checked[{/if}]> Test
                </dd>
                <div class="spacer"></div>
            </dl>
        </div>
    ...
    <div class="groupExp">
        <div>
            <a href="#" onclick="_groupExp(this);return false;"
               class="rc"><b>[{oxmultilang ident="FCPO_CONFIG_GROUP_CREDITCARD"}]</b></a>
            <dl>
                <dt>
                    <select name="confstrs[sFCPOCCType]">
                        <option value="hosted" [{if $confstrs.sFCPOCCType == "hosted"}]SELECTED[{/if}]>hosted-Iframe
                        </option>
            ...
            <dl>
                <dd>
                    <a href="#" onclick="toggleHostedTemplate();"
                       style="text-decoration: underline;">[{oxmultilang ident="FCPO_CC_CUSTOM_TEMPLATE"}]</a>
                    <div id="fcpoHostedCCTemplate" style="display:none;padding-top:10px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select name="confstrs[[{$sFieldIdent}]]">
                                        ...
                                        <option value="[{$sType}]"
                                                [{if $sType == $confstrs.$sFieldIdent}]selected[{/if}]>[{$sTitle}]
                                        </option>
                                        [{/foreach}]
                                    </select>
                                </td>
                                <td>
                                    ...
                                    <input type="text" class="txt" size="4" name="confstrs[[{$sFieldIdent}]]"
                                           value="[{$confstrs.$sFieldIdent}]" [{$readonly}]>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <select name="confstrs[[{$sFieldIdentIframe}]]"
                                            onchange="handleSizeFields(this, '[{$sField}]')">
                                        [{foreach from=$oView->getCCStyles() key=sType item=sTitle}]
                                        <option value="[{$sType}]"
                                                [{if $sType == $confstrs.$sFieldIdentIframe}]selected[{/if}]>[{$sTitle}]
                                        </option>
                                        [{/foreach}]
                                    </select>
                                </td>
                                <td>
                                    ...
                                    <input id="input_width_[{$sField}]" type="text" class="txt" size="4"
                                           name="confstrs[[{$sFieldIdent}]]" value="[{$confstrs.$sFieldIdent}]"
                                           [{$readonly}] [{if $confstrs.$sFieldIdentIframe != "custom"}]disabled[{/if}]>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <select name="confstrs[[{$sFieldIdentCSS}]]"
                                            onchange="handleCss(this, '[{$sField}]')">
                                        [{foreach from=$oView->getCCStyles() key=sType item=sTitle}]
                                        <option value="[{$sType}]"
                                                [{if $sType == $confstrs.$sFieldIdentCSS}]selected[{/if}]>[{$sTitle}]
                                        </option>
                                        [{/foreach}]
                                    </select>
                                </td>
                                <td>
                                    ...
                                    <input id="input_css_[{$sField}]" type="text" class="txt" size="50"
                                           name="confstrs[[{$sFieldIdent}]]" value="[{$confstrs.$sFieldIdent}]"
                                           [{$readonly}] [{if $confstrs.$sFieldIdentCSS != "custom"}]disabled[{/if}]>
                                    [{if $sFieldIdent=='sFCPOCCCVCCSS'}]
                                    &nbsp;
                                <input type="hidden" name="confbools[blFCPOCCUseCvc]" value="false">
                                <input type="checkbox" name="confbools[blFCPOCCUseCvc]" value="true"
                                       [{if ($confbools.blFCPOCCUseCvc)}]checked[{/if}]> [{oxmultilang ident="FCPO_CC_USE_CVC"}]
                                    [{/if}]
                                </td>
                            </tr>
                            [{/foreach}]
                        ...
                        <table>
                            <tr>
                                <th style="text-align:left;width:120px;">[{oxmultilang ident="FCPO_CC_STANDARD_STYLE"}
                                    ]
                                </th>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="txt" size="50" name="confstrs[sFCPOCCStandardInput]"
                                           value="[{$confstrs.sFCPOCCStandardInput}]" [{$readonly}]></td>
                                <td><input type="text" class="txt" size="50" name="confstrs[sFCPOCCStandardOutput]"
                                           value="[{$confstrs.sFCPOCCStandardOutput}]" [{$readonly}]></td>
                            </tr>
                            <tr>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td><input type="text" class="txt" size="4"
                                                       ...
                                                       value="[{$confstrs.sFCPOCCIframeWidth}]" [{$readonly}]></td>
                                            <td><input type="text" class="txt" size="4"
                                                       name="confstrs[sFCPOCCIframeHeight]"
                                                       value="[{$confstrs.sFCPOCCIframeHeight}]" [{$readonly}]></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="checkbox" name="confbools[blFCPOCCErrorsActive]" value="true"
                                           [{if ($confbools.blFCPOCCErrorsActive)}]checked[{/if}]>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select name="confstrs[sFCPOCCErrorsLang]">
                                        <option value="de" [{if $confstrs.sFCPOCCErrorsLang == "de"}]selected[{/if}]>
                                            [{oxmultilang ident="FCPO_CC_ERRORLANG_DE"}]
                                        </option>
                                        <option value="en" [{if $confstrs.sFCPOCCErrorsLang == "en"}]selected[{/if}]>
                                            [{oxmultilang ident="FCPO_CC_ERRORLANG_EN"}]
                                        </option>
                                    </select>
                                </td>
                            </tr>
                        ...
                        <br>
                        <a href="#" onclick="togglePreview();"
                           style="text-decoration: underline;">[{oxmultilang ident="FCPO_CC_PREVIEW"}]</a>
                        <div id="fcpoHostedCCPreview" style="display:none;padding-top:10px;">
                            [{include file="fcpayone_cc_preview.html.twig"}]
                        </div>
                    </div>
                </dd>
                <div class="spacer"></div>
    ...
    <div class="groupExp">
        <div>
            <a href="#" onclick="_groupExp(this);return false;"
               class="rc"><b>[{oxmultilang ident="FCPO_CONFIG_GROUP_DEBITNOTE"}]</b></a>
            <dl>
            ...
            <dl style="border-top:0px;">
                <dt>
                    <select class="select" multiple size="4" name="confarrs[aFCPODebitCountries][]" [{$readonly}]>
                        ...
                        <option value="[{$oCountry->oxcountry__oxid->value}]" [{if $oCountry->selected}]
                                selected[{/if}]>[{$oCountry->oxcountry__oxtitle->value}]
                        </option>
                        [{/foreach}]
                    </select>
                </dt>
            ...
            <dl style="border-top:0px;">
                <dt>
                    ...
                    <input type="checkbox" name="confbools[blFCPODebitBICMandatory]" value="true"
                           [{if ($confbools.blFCPODebitBICMandatory)}]checked[{/if}]>
                </dt>
                <dd>
            ...
            <dl style="border-top:0px;">
                <dt>
                    ...
                    <input type="checkbox" name="confbools[blFCPOMandateIssuance]" value="true"
                           [{if ($confbools.blFCPOMandateIssuance)}]checked[{/if}]>
                </dt>
                <dd>
            ...
            <dl style="border-top:0px;">
                <dt>
                    ...
                    <input type="checkbox" name="confbools[blFCPOMandateDownload]" value="true"
                           [{if ($confbools.blFCPOMandateDownload)}]checked[{/if}]>
                </dt>
                <dd>
    ...
    <div class="groupExp">
        <div
        [{if $oView->fcpoIsStoreIdAdded()}] class="exp"[{/if}]>
        <a href="#" onclick="_groupExp(this);return false;"
           class="rc"><b>[{oxmultilang ident="FCPO_CONFIG_GROUP_KLARNA"}]</b></a>
        <dl>
            <dt></dt>
            <dd>
        ...
        <dl>
            ...
            <dd>
                StoreID
                <input type="button"
                       onclick="showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=KLV&amp;type=[{$sKey}]');"
                       class="" value="[{oxmultilang ident="GENERAL_ASSIGNCOUNTRIES"}]">
                <input type="submit" class="edittext" name="aStoreIds[[{$sKey}]][delete]"
                       value="[{oxmultilang ident="FCPO_KLARNA_DELETE_STORE_ID"}]"
        ...
        [{/foreach}]
        <dl>
            <dt><input type="submit" class="edittext" name="addStoreId"
                       value="[{oxmultilang ident="FCPO_KLARNA_ADD_STORE_ID"}]"
    ...
    <div class="groupExp">
        <div
        [{if $oView->fcpoIsCampaignAdded()}] class="exp"[{/if}]>
        <a href="#" onclick="_groupExp(this);return false;"
           class="rc"><b>[{oxmultilang ident="FCPO_CONFIG_GROUP_KLARNA_CAMPAIGNS"}]</b></a>
        <dl>
            <dt></dt>
            <dd>
            ...
            <dd>
                <table>
                    <tr>
                        ...
                        <td>
                            <input type="text" class="txt" name="aCampaigns[[{$sId}]][code]" value="[{$aCampaign.code}]"
                                   size="8" [{$readonly}]>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="txt" name="aCampaigns[[{$sId}]][title]"
                                   value="[{$aCampaign.title}]" size="50" [{$readonly}]>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="button"
                                   onclick="showDialog('[{$oView->fcGetAdminSeperator()}]cl=FcPayOneMain&amp;aoc=1&amp;oxid=KLR_[{$sId}]&amp;type=[{$sKey}]');"
                                   class="" value="[{oxmultilang ident="FCPO_ASSIGN_COUNTRIES"}]">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <select class="select" multiple size="[{$aLanguages|@count}]"
                                    name="aCampaigns[[{$sId}]][language][]" [{$readonly}]>
                                [{foreach from=$aLanguages key=sLangId item=sLangTitle}]
                                <option value="[{$sLangId}]"
                                        [{if $sLangId|in_array:$aCampaign.language}]selected[{/if}]>[{$sLangTitle}]
                                </option>
                                [{/foreach}]
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select class="select" multiple size="[{$aCurrencies|@count}]"
                                    name="aCampaigns[[{$sId}]][currency][]" [{$readonly}]>
                                [{foreach from=$aCurrencies key=sCurrId item=sCurrTitle}]
                                <option value="[{$sCurrId}]"
                                        [{if $sCurrId|in_array:$aCampaign.currency}]selected[{/if}]>[{$sCurrTitle}]
                                </option>
                                [{/foreach}]
                            </select>
                        </td>
                ...
                <input type="submit" class="edittext" name="aCampaigns[[{$sId}]][delete]"
                       value="[{oxmultilang ident="FCPO_KLARNA_DELETE_STORE_ID"}]"
                       onClick="Javascript:document.myedit.fnc.value='save'" [{$readonly}]>
            </dd>
            <div class="spacer"></div>
        ...
        [{/foreach}]
        <dl>
            <dt><input type="submit" class="edittext" name="addCampaign"
                       value="[{oxmultilang ident="FCPO_KLARNA_ADD_CAMPAIGN"}]"
                       onClick="Javascript:document.myedit.fnc.value='save'" [{$readonly}]></dt>
            <dd></dd>
            <div class="spacer"></div>
        </dl>
    ...
    <div class="groupExp">
        <div
        [{if $oView->fcpoIsLogoAdded()}] class="exp"[{/if}]>
        <a href="#" onclick="_groupExp(this);return false;"
           class="rc"><b>[{oxmultilang ident="FCPO_CONFIG_GROUP_PP_EXPRESS_LOGOS"}]</b></a>
        <dl>
            <dt>
                ...
                <input type="checkbox" name="confbools[blFCPOPayPalDelAddress]" value="true"
                       [{if ($confbools.blFCPOPayPalDelAddress)}]checked[{/if}]>
        ...
        <dl>
            ...
            <dd>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="checkbox" name="logos[[{$aLogo.oxid}]][active]" value="1"
                                   [{if ($aLogo.active)}]checked[{/if}]>
                        </td>
                        <td>
                            <select name="logos[[{$aLogo.oxid}]][langid]" class="editinput">
                                [{foreach from=$languages item=lang}]
                                <option value="[{$lang->id}]" [{if $lang->id == $aLogo.langid}]SELECTED[{/if}]>
                                    [{$lang->name}]
                                </option>
                                [{/foreach}]
                            </select>
                ...
                <input type="submit" class="edittext" name="addPayPalLogo"
                       value="[{oxmultilang ident="FCPO_CONFIG_ADD_PP_EXPRESS_LOGO"}]"
                       onClick="Javascript:document.myedit.fnc.value='save'" [{$readonly}]>
            </dd>
            <div class="spacer"></div>
        </dl>
    ...
    <div class="groupExp">
        <div>
            <a href="#" onclick="_groupExp(this);return false;"
               class="rc"><b>[{oxmultilang ident="FCPO_CONFIG_GROUP_PAYOLUTION"}]</b></a>
            <dl>
                <dt>
                    ...
                    <input type="checkbox" class="txt" name="confbools[blFCPOPayolutionB2BMode]" value="true"
                           [{if $confbools.blFCPOPayolutionB2BMode}]checked[{/if}] [{$readonly}]>
            ...
            <dl>
                <dt>
                    <input type="text" class="txt" name="confstrs[sFCPOPayolutionCompany]"
                           value="[{$confstrs.sFCPOPayolutionCompany}]" [{$readonly}]>
            ...
            <dl>
                <dt>
                    <input type="text" class="txt" name="confstrs[sFCPOPayolutionAuthUser]"
                           value="[{$confstrs.sFCPOPayolutionAuthUser}]" [{$readonly}]>
            ...
            <dl>
                <dt>
                    <input type="text" class="txt" name="confstrs[sFCPOPayolutionAuthSecret]"
                           value="[{$confstrs.sFCPOPayolutionAuthSecret}]" [{$readonly}]>
    ...
    <div class="groupExp">
        <div>
            <a href="#" onclick="_groupExp(this);return false;"
               class="rc"><b>[{oxmultilang ident="FCPO_CONFIG_GROUP_RATEPAY"}]</b></a>
            <dl>
                <dt></dt>
                <dd>
            ...
            <dl>
                <dt>
                    ...
                    <input type="checkbox" class="txt" name="confbools[blFCPORatePayB2BMode]" value="true"
                           [{if $confbools.blFCPORatePayB2BMode}]checked[{/if}] [{$readonly}]>
            ...
            <dl>
                <dt>
                    <input type="text" class="txt" name="confstrs[sFCPORatePaySnippetID]"
                           [{if $confstrs.sFCPORatePaySnippetID == '' || $confstrs.sFCPORatePaySnippetID == 'ratepay'  }]
                           value="ratepay" [{else}] value="[{$confstrs.sFCPORatePaySnippetID}]" [{/if}]>
                </dt>
                <dd>
                    Ratepay Snippet ID
                </dd>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <select class="edittext" name="aRatepayProfiles[[{$sOxid}]][currency]">
                        ...
                        <option value="[{$sCurrentCurrencyIso}]"
                                [{if $aRatePayProfile.currency == $sCurrentCurrencyIso}]selected[{/if}]>
                            [{$sCurrentCurrencyIso}]
                        </option>
                        [{/foreach}]
                    </select>&nbsp;
                    ...
                    <select class="edittext" name="aRatepayProfiles[[{$sOxid}]][paymentid]">
                        <option value="fcporp_bill" [{if $aRatePayProfile.OXPAYMENTID == 'fcporp_bill'}]selected[{/if}]>
                            Ratepay Rechnung
                        </option>
                        <option value="fcporp_debitnote"
                                [{if $aRatePayProfile.OXPAYMENTID == 'fcporp_debitnote'}]selected[{/if}]>Ratepay
                            Lastschrift
                        </option>
                    </select>
                    <input type="submit" class="edittext" name="aRatepayProfiles[[{$sOxid}]][delete]"
                           value="[{oxmultilang ident="FCPO_RATEPAY_DELETE_PROFILE"}]"
                ...
                <input type="checkbox" value="[{$sOxid}]"
                       onclick="handleRatePayShowDetails(this)"> [{oxmultilang ident="FCPO_RATEPAY_PROFILE_TOGGLE_DETAILS"}]
                    [{/if}]
                </dd>
                <div class="spacer"></div>
            </dl>
            ...
            <dl>
                <dt><input type="submit" class="edittext" name="addRatePayProfile"
                           value="[{oxmultilang ident="FCPO_RATEPAY_ADD_PROFILE"}]"
                           onClick="Javascript:document.myedit.fnc.value='save'" [{$readonly}]></dt>
                <dd></dd>
                <div class="spacer"></div>
            </dl>
    ...
    <div class="groupExp">
        <div>
            <a href="#" onclick="_groupExp(this);return false;"
               class="rc"><b>[{oxmultilang ident="FCPO_CONFIG_GROUP_AMAZONPAY"}]</b></a>
            <dl>
                <dt>
                    <input type="text" class="txt" name="confstrs[sFCPOAmazonPaySellerId]"
                           value="[{$confstrs.sFCPOAmazonPaySellerId}]" disabled>
            ...
            <dl>
                <dt>
                    <input type="text" class="txt" name="confstrs[sFCPOAmazonPayClientId]"
                           value="[{$confstrs.sFCPOAmazonPayClientId}]" disabled>
            ...
            <dl>
                <dt><input type="submit" class="edittext" name="getAmazonPayConfiguration"
                           value="[{oxmultilang ident="FCPO_AMAZONPAY_GET_CONFIG"}]"
                           onClick="Javascript:document.myedit.fnc.value='save'" [{$readonly}]></dt>
                <dd></dd>
                <div class="spacer"></div>
            </dl>
            <dl>
                <dt>
                    <select name="confstrs[sFCPOAmazonButtonType]">
                        <option value="PwA" [{if $confstrs.sFCPOAmazonButtonType == "PwA"}]selected[{/if}]>
                            [{oxmultilang ident="FCPO_AMAZONPAY_BUTTON_TYPE_PwA"}]
                        </option>
                        <option value="Pay" [{if $confstrs.sFCPOAmazonButtonType == "Pay"}]selected[{/if}]>
                            [{oxmultilang ident="FCPO_AMAZONPAY_BUTTON_TYPE_Pay"}]
                        </option>
                        <option value="A" [{if $confstrs.sFCPOAmazonButtonType == "A"}]selected[{/if}]>
                            [{oxmultilang ident="FCPO_AMAZONPAY_BUTTON_TYPE_A"}]
                        </option>
                    </select>
                </dt>
                <dd>
            ...
            <dl>
                <dt>
                    <select name="confstrs[sFCPOAmazonButtonColor]">
                        <option value="Gold" [{if $confstrs.sFCPOAmazonButtonColor == "Gold"}]selected[{/if}]>
                            [{oxmultilang ident="FCPO_AMAZONPAY_BUTTON_COLOR_GOLD"}]
                        </option>
                        <option value="LightGray" [{if $confstrs.sFCPOAmazonButtonColor == "LightGray"}]selected[{/if}]>
                            [{oxmultilang ident="FCPO_AMAZONPAY_BUTTON_TYPE_LIGHT_GRAY"}]
                        </option>
                        <option value="DarkGray" [{if $confstrs.sFCPOAmazonButtonColor == "DarkGray"}]selected[{/if}]>
                            [{oxmultilang ident="FCPO_AMAZONPAY_BUTTON_TYPE_DARKGRAY"}]
                        </option>
                    </select>
                </dt>
                <dd>
            ...
            <dl>
                <dt>
                    <select name="confstrs[sFCPOAmazonMode]">
                        <option value="alwayssync" [{if $confstrs.sFCPOAmazonMode == "alwayssync"}]selected[{/if}]>
                            [{oxmultilang ident="FCPO_AMAZONPAY_MODE_ALWAYSSYNC"}]
                        </option>
                        <option value="firstsyncthenasync"
                                [{if $confstrs.sFCPOAmazonMode == "firstsyncthenasync"}]selected[{/if}]>
                            [{oxmultilang ident="FCPO_AMAZONPAY_MODE_FIRSTSYNCTHENSYNC"}]
                        </option>
                    </select>
                </dt>
                <dd>
            ...
            <dl>
                <dt>
                    <select name="confstrs[sFCPOAmazonLoginMode]">
                        <option value="auto" [{if $confstrs.sFCPOAmazonLoginMode == "auto"}]selected[{/if}]>
                            [{oxmultilang ident="FCPO_AMAZONPAY_LOGINMODE_AUTO"}]
                        </option>
                        <option value="popup" [{if $confstrs.sFCPOAmazonLoginMode == "popup"}]selected[{/if}]>
                            [{oxmultilang ident="FCPO_AMAZONPAY_LOGINMODE_POPUP"}]
                        </option>
                        <option value="redirect" [{if $confstrs.sFCPOAmazonLoginMode == "redirect"}]selected[{/if}]>
                            [{oxmultilang ident="FCPO_AMAZONPAY_LOGINMODE_REDIRECT"}]
                        </option>
                    </select>
                </dt>
                <dd>
    ...
    <div class="groupExp">
        <div>
            <a href="#" onclick="_groupExp(this);return false;"
               class="rc"><b>[{oxmultilang ident="FCPO_CONFIG_GROUP_SECINVOICE"}]</b></a>
            <dl>
                <dt>
            ...
            <dl>
                <dt>
                    <input type="text" class="txt" name="confstrs[sFCPOSecinvoicePortalKey]"
                           value="[{$confstrs.sFCPOSecinvoicePortalKey}]" [{$readonly}]>
    ...
    <div class="groupExp">
        <div>
            <a href="#" onclick="_groupExp(this);return false;"
               class="rc"><b>[{oxmultilang ident="FCPO_CONFIG_GROUP_PAYDIREKT"}]</b></a>
            <dl>
                <dt>
                    <select name="confstrs[sPaydirektExpressButtonType]">
                        <option value="none" [{if $confstrs.sPaydirektExpressButtonType == "none"}]SELECTED[{/if}]>
                            [{oxmultilang ident="FCPO_PAYDIREKT_EXPRESS_BUTTON_NONE"}]
                        </option>
                        <option value="green" [{if $confstrs.sPaydirektExpressButtonType == "green"}]SELECTED[{/if}]>
                            [{oxmultilang ident="FCPO_PAYDIREKT_EXPRESS_BUTTON_GREEN"}]
                        </option>
                        <option value="green2" [{if $confstrs.sPaydirektExpressButtonType == "green2"}]SELECTED[{/if}]>
                            [{oxmultilang ident="FCPO_PAYDIREKT_EXPRESS_BUTTON_GREEN2"}]
                        </option>
                        <option value="white" [{if $confstrs.sPaydirektExpressButtonType == "white"}]SELECTED[{/if}]>
                            [{oxmultilang ident="FCPO_PAYDIREKT_EXPRESS_BUTTON_WHITE"}]
                        </option>
                        <option value="white2" [{if $confstrs.sPaydirektExpressButtonType == "white2"}]SELECTED[{/if}]>
                            [{oxmultilang ident="FCPO_PAYDIREKT_EXPRESS_BUTTON_WHITE2"}]
                        </option>
                    </select>
            ...
            <dl>
                <dt>
                    <input type="text" class="txt" name="confstrs[sPaydirektShippingTermsUrl]"
                           value="[{$confstrs.sPaydirektShippingTermsUrl}]">
            ...
            <dl>
                <dt>
                    <select name="confstrs[sPaydirektExpressDeliverySetId]">
                        <option value="none" [{if $confstrs.sPaydirektExpressDeliverySetId == "none"}]SELECTED[{/if}]>
                            [{oxmultilang ident="FCPO_PAYDIREKT_EXPRESS_DELIVERY_NONE"}]
                        </option>
                        ...
                        <option value="[{$sCurrentSetId}]"
                                [{if $confstrs.sPaydirektExpressDeliverySetId == $sCurrentSetId}]SELECTED[{/if}]>
                            [{$sCurrentSetName}]
                        </option>
                        [{/foreach}]
                    </select>
    ...
    <div class="groupExp">
        <div>
            <a href="#" onclick="_groupExp(this);return false;"
               class="rc"><b>[{oxmultilang ident="FCPO_FORWARD_REDIRECTS"}]</b></a>
            <dl>
                <dt>
                    <select name="confstrs[sTransactionRedirectLogging]">
                        <option value="none" [{if $confstrs.sTransactionRedirectLogging == "none"}]SELECTED[{/if}]>
                            [{oxmultilang ident="FCPO_TRANSACTIONREDIRECTLOGGING_NONE"}]
                        </option>
                        <option value="all" [{if $confstrs.sTransactionRedirectLogging == "all"}]SELECTED[{/if}]>
                            [{oxmultilang ident="FCPO_TRANSACTIONREDIRECTLOGGING_ALL"}]
                        </option>
                    </select>
            ...
            <dl>
                <dt>
                    <select name="confstrs[sTransactionRedirectMethod]">
                        <option value="direct" [{if $confstrs.sTransactionRedirectMethod == "direct"}]SELECTED[{/if}]>
                            [{oxmultilang ident="FCPO_TRANSACTIONREDIRECTMETHOD_DIRECT"}]
                        </option>
                        <option value="cronjob" [{if $confstrs.sTransactionRedirectMethod == "cronjob"}]SELECTED[{/if}]>
                            [{oxmultilang ident="FCPO_TRANSACTIONREDIRECTMETHOD_CRONJOB"}]
                        </option>
                    </select>
    ...
    <input type="submit" class="edittext" name="save" value="[{oxmultilang ident="GENERAL_SAVE"}]"
           onClick="Javascript:document.myedit.fnc.value='save'" [{$readonly}]>
    <input type="submit" class="edittext" name="export" value="[{oxmultilang ident="FCPO_EXPORT_CONFIG"}]"
           target="_blank" onClick="Javascript:document.myedit.fnc.value='export'" [{$readonly}]>
</form>

[{include file="bottomnaviitem.html.twig"}]

[{include file="bottomitem.html.twig"}]
