[{include file="headitem.html.twig" title="[OXID Benutzerverwaltung]"}]
...
<form autocomplete="off" name="transfer" id="transfer" action="[{$oViewConf->getSelfLink()}]" method="post">
    ...
    <input type="hidden" name="cl" value="FcPayOneOrder">
</form>
...
<form autocomplete="off" name="myedit" id="myedit" action="[{$oViewConf->getSelfLink()}]" method="post">
    ...
    <input type="hidden" name="oxid" value="[{$oxid}]">
    <input type="hidden" name="status_oxid" value="[{$status_oxid}]">
    <input type="hidden" id="fc_error_message_capture_greater_null"
           value="[{oxmultilang ident="FCPO_CAPTURE_AMOUNT_GREATER_NULL"}]">
            ...
            <td width="45%" valign="top">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="edittext">
                            <a href="[{$sMandateUrl}]" target="_blank"
                               style="text-decoration:underline;">[{oxmultilang ident="FCPO_MANDATE_DOWNLOAD"}]</a>
                        </td>
                    </tr>
                    [{/if}]
                    ...
                    <tr>
                        <td class="edittext" colspan="2"><strong>[{oxmultilang ident="FCPO_CAPTURE"}]</strong></td>
                    </tr>
                    <tr>
                        <td colspan="2">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <table border="0" cellpadding="5" callspacing="5">
                                ...
                                <tr>
                                    <td>
                                        <input type="hidden" name="capture_positions[[{$oOrderArt->getId()}]][price]"
                                               value="[{$oOrderArt->oxorderarticles__oxbprice->value}]">
                                        <input type="hidden" name="capture_positions[[{$oOrderArt->getId()}]][capture]"
                                               value="0">
                                        <input type="checkbox"
                                               name="capture_positions[[{$oOrderArt->getId()}]][capture]" value="1"
                                               checked>
                                    </td>
                                    <td><input type="text" size="3"
                                               name="capture_positions[[{$oOrderArt->getId()}]][amount]"
                                               value="[{$iLeftAmount}]"></td>
                                    <td>[{$oOrderArt->oxorderarticles__oxbprice->value|number_format:2:",":""}]
                                        [{$edit->oxorder__oxcurrency->value}]
                                    </td>
                    ...
                    <tr>
                        <td class="edittext" colspan="2">
                            <input type="button"
                                   onclick="document.myedit.fnc.value='capture';document.myedit.submit();return false;"
                                   value="[{oxmultilang ident="FCPO_EXECUTE"}]" style="padding: 0 4px 0 4px;">
                        </td>
                    </tr>
                    [{/if}]
                    [{else}]
                    ...
                    <tr>
                        <td class="edittext">
                            <strong>[{oxmultilang ident="FCPO_AMOUNT_IN"}] [{$edit->oxorder__oxcurrency->value}
                                ]</strong>
                        </td>
                        <td class="edittext">
                            <input id="fc_capture_amount" type="text" name="capture_amount" value="0,00">
                            <input type="button" onclick="onClickCapture(this);"
                                   value="[{oxmultilang ident="FCPO_EXECUTE"}]" style="padding: 0 4px 0 4px;">
                        </td>
                    </tr>
                    [{/if}]
                    ...
                    <tr>
                        <td class="edittext" colspan="2"><strong>[{oxmultilang ident="FCPO_DEBIT"}]</strong></td>
                    </tr>
                    [{if $edit->debitNeedsBankData()}]
                    <tr>
                        <td class="edittext" colspan="2" style="width: 300px;">
                            [{oxmultilang ident="FCPO_HEADER_BANKACCOUNT"}] -
                            <span id="fcShowBankaccount" style="width: 100px;">
                                            <a href="#"
                                               onclick="toggleBankaccount();return false;">[{oxmultilang ident="FCPO_SHOW"}]</a>
                                        </span>
                            <span id="fcHideBankaccount" style="display: none;width: 100px;">
                                            <a href="#"
                                               onclick="toggleBankaccount();return false;">[{oxmultilang ident="FCPO_HIDE"}]</a>
                                        </span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <table border="0" cellpadding="5" callspacing="5">
                                ...
                                <tr>
                                    <td>
                                        <input type="hidden" name="debit_positions[[{$oOrderArt->getId()}]][price]"
                                               value="[{$oOrderArt->oxorderarticles__oxbprice->value}]">
                                        <input type="hidden" name="debit_positions[[{$oOrderArt->getId()}]][debit]"
                                               value="0">
                                        <input type="checkbox" name="debit_positions[[{$oOrderArt->getId()}]][debit]"
                                               value="1" checked>
                                    </td>
                                    <td>
                                        [{if $edit->oxorder__fcpoauthmode->value == 'preauthorization'}]
                                    <input type="text" size="3" name="debit_positions[[{$oOrderArt->getId()}]][amount]"
                                           value="[{$oOrderArt->oxorderarticles__fcpocapturedamount->value}]">
                                        [{else}]
                                    <input type="text" size="3" name="debit_positions[[{$oOrderArt->getId()}]][amount]"
                                           value="[{$iLeftAmount}]">
                                        [{/if}]
                                ...
                                <tr>
                                    <td>
                                        <input type="hidden" name="debit_positions[oxdelcost][price]"
                                               value="[{$edit->oxorder__oxdelcost->value}]">
                                        <input type="hidden" name="debit_positions[oxdelcost][debit]" value="0">
                                        <input type="checkbox" name="debit_positions[oxdelcost][debit]" value="1"
                                               checked>
                                    </td>
                                    <td><input type="hidden" name="debit_positions[oxdelcost][amount]" value="1">1</td>
                                    <td>[{$edit->oxorder__oxdelcost->value|number_format:2:",":""}]
                                        [{$edit->oxorder__oxcurrency->value}]
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <input type="hidden" name="debit_positions[oxpaycost][price]"
                                               value="[{$edit->oxorder__oxpaycost->value}]">
                                        <input type="hidden" name="debit_positions[oxpaycost][debit]" value="0">
                                        <input type="checkbox" name="debit_positions[oxpaycost][debit]" value="1"
                                               checked>
                                    </td>
                                    <td><input type="hidden" name="debit_positions[oxpaycost][amount]" value="1">1</td>
                                    <td>[{$edit->oxorder__oxpaycost->value|number_format:2:",":""}]
                                        [{$edit->oxorder__oxcurrency->value}]
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <input type="hidden" name="debit_positions[oxwrapcost][price]"
                                               value="[{$edit->oxorder__oxwrapcost->value}]">
                                        <input type="hidden" name="debit_positions[oxwrapcost][debit]" value="0">
                                        <input type="checkbox" name="debit_positions[oxwrapcost][debit]" value="1"
                                               checked>
                                    </td>
                                    <td><input type="hidden" name="debit_positions[oxwrapcost][amount]" value="1">1</td>
                                    <td>[{$edit->oxorder__oxwrapcost->value|number_format:2:",":""}]
                                        [{$edit->oxorder__oxcurrency->value}]
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="hidden" name="debit_positions[oxgiftcardcost][price]"
                                               value="[{$edit->oxorder__oxgiftcardcost->value}]">
                                        <input type="hidden" name="debit_positions[oxgiftcardcost][debit]" value="0">
                                        <input type="checkbox" name="debit_positions[oxgiftcardcost][debit]" value="1"
                                               checked>
                                    </td>
                                    <td><input type="hidden" name="debit_positions[oxgiftcardcost][amount]" value="1">1
                                    </td>
                                    <td>[{$edit->oxorder__oxgiftcardcost->value|number_format:2:",":""}]
                                        [{$edit->oxorder__oxcurrency->value}]
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="hidden" name="debit_positions[oxvoucherdiscount][price]"
                                               value="[{$dNegativeAmount}]">
                                        <input type="hidden" name="debit_positions[oxvoucherdiscount][debit]" value="0">
                                        <input type="checkbox" name="debit_positions[oxvoucherdiscount][debit]"
                                               value="1" checked>
                                    </td>
                                    <td><input type="hidden" name="debit_positions[oxvoucherdiscount][amount]"
                                               value="1">1
                                    </td>
                                    <td>[{$dNegativeAmount|number_format:2:",":""}] [{$edit->oxorder__oxcurrency->value}
                                        ]
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="hidden" name="debit_positions[oxdiscount][price]"
                                               value="[{$dNegativeAmount}]">
                                        <input type="hidden" name="debit_positions[oxdiscount][debit]" value="0">
                                        <input type="checkbox" name="debit_positions[oxdiscount][debit]" value="1"
                                               checked>
                                    </td>
                    ...
                    <tr>
                        <td class="edittext" colspan="2">
                            <input type="button"
                                   onclick="document.myedit.fnc.value='debit';document.myedit.submit();return false;"
                                   value="[{oxmultilang ident="FCPO_EXECUTE"}]" style="padding: 0 4px 0 4px;">
                        </td>
                    </tr>
                    [{else}]
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button"
                                   onclick="if(confirm('[{oxmultilang ident="FCPO_ARE_YOU_SURE"}]')) {this.form.fnc.value='debit';this.form.submit();}"
                                   value="[{oxmultilang ident="FCPO_EXECUTE"}]" style="padding: 0 4px 0 4px;">
                        </td>
                    </tr>
                    [{/if}]
            ...
            <td valign="top">
                ...
                <div id="liste">
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        ...
                        <tr>
                            <td class="[{$listclass}]" style="padding-left: 5px;"><a
                                        href="Javascript:editThisStatus('[{$stat->fcpotransactionstatus__oxid->value}]',
    '[{$oxid}]');">[{$stat->fcpotransactionstatus__oxtimestamp->value}
                                    ]</a>&nbsp;
                            </td>
                            <td class="[{$listclass}]" style="padding-left: 5px;">
                                [{$stat->getDisplayNameReceivable($receivable-$last_receivable)}]&nbsp;
                            </td>
                            <td class="[{$listclass}]"
                                style="padding-left: 5px; [{if $receivable-$last_receivable < 0}]color: red;[{/if}]">
                                [{$receivable-$last_receivable|number_format:2:',':''}
                                ]&nbsp;[{$stat->fcpotransactionstatus__fcpo_currency->value}]
                            </td>
    ...
    '[{$oxid}]');">[{$stat->fcpotransactionstatus__oxtimestamp->value}
                            ...
                            <td class="[{$listclass}]" style="padding-left: 5px;">
                                [{$stat->getDisplayNamePayment($payment-$last_payment)}]&nbsp;
                            </td>
                            <td class="[{$listclass}]" style="padding-left: 5px;">&nbsp;</td>
                            <td class="[{$listclass}]"
                                style="padding-left: 5px; [{if $payment-$last_payment < 0}]color: red;[{/if}]">
                                [{$payment-$last_payment|number_format:2:',':''}
                                ]&nbsp;[{$stat->fcpotransactionstatus__fcpo_currency->value}]
                            </td>
                        </tr>
                        [{if $listclass == "listitem2"}]
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td align="right">
                                <strong>[{oxmultilang ident="FCPO_BALANCE"}]: <span
                                            [{if $stat->fcpotransactionstatus__fcpo_balance->value < 0}]style="color: red;"
                                            [{/if}]>[{$stat->fcpotransactionstatus__fcpo_balance->value|number_format:2:',':''}]&nbsp;[{$stat->fcpotransactionstatus__fcpo_currency->value}]</span></strong>
                            </td>
                        </tr>
                    </table>
                    [{/if}]
