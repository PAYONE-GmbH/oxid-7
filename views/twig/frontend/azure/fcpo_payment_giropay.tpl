        ...
        <div class="form-group" id="fcpo_ou_iban_gpy">
            ...
            <div class="col-lg-9">
                <input placeholder="[{oxmultilang ident="FCPO_BANK_IBAN"}]" class="form-control" autocomplete="off"
                       type="text" size="20" maxlength="64" name="dynvalue[fcpo_ou_iban_gpy]"
                       value="[{$dynvalue.fcpo_ou_iban_gpy}]">
        ...
        <div class="form-group" id="fcpo_ou_bic_gpy">
            ...
            <div class="col-lg-9">
                <input placeholder="[{oxmultilang ident="FCPO_BANK_BIC"}]" class="form-control" autocomplete="off"
                       type="text" size="20" maxlength="64" name="dynvalue[fcpo_ou_bic_gpy]"
                       value="[{$dynvalue.fcpo_ou_bic_gpy}]">
