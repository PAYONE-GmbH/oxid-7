        ...
        <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
            ...
            <ul class="form fcporp_debitnote_form">
                ...
                <li>
                    ...
                    <input placeholder="[{oxmultilang ident="FCPO_RATEPAY_USTID"}]" type='text'
                ...
                <li>
                    ...
                    <input placeholder="[{oxmultilang ident="FCPO_RATEPAY_FON"}]" type='text'
                ...
                <li>
                    ...
                    <input placeholder="[{oxmultilang ident="FCPO_BANK_BIC"}]" autocomplete="off" type="text" size="20"
                           maxlength="64" name="dynvalue[fcpo_ratepay_debitnote_bic]"
                ...
                <li>
                    <input name="dynvalue[fcpo_ratepay_debitnote_agreed]" value="agreed"
                           type="checkbox">[{oxmultilang ident="FCPO_RATEPAY_AGREE"}]
                    [{oxmultilang ident="FCPO_RATEPAY_AGREEMENT_PART_2"}]
                </li>
                <li>
                    <input name="dynvalue[fcpo_ratepay_debitnote_sepa_agreed]" value="agreed"
                           type="checkbox">&nbsp;[{oxmultilang ident="FCPO_RATEPAY_SEPA_AGREEMENT_PART_1"}]
                    [{oxmultilang ident="FCPO_RATEPAY_SEPA_AGREE"}]
                </li>
            </ul>
