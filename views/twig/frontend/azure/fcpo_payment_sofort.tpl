<dl>
    ...
    <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
        ...
        <div class="form-group" id="fcpo_ou_blz">
            ...
            <div class="col-lg-9">
                <input placeholder="[{oxmultilang ident="FCPO_BANK_CODE"}]" class="form-control" autocomplete="off"
                       type="text" size="20" maxlength="64" name="dynvalue[fcpo_ou_blz]"
        ...
        <div class="form-group" id="fcpo_ou_iban">
            ...
            <div class="col-lg-9">
                <input placeholder="[{oxmultilang ident="FCPO_BANK_IBAN"}]" class="form-control" autocomplete="off"
                       type="text" size="20" maxlength="64" name="dynvalue[fcpo_ou_iban]"
        ...
        <div class="form-group" id="fcpo_ou_bic">
            ...
            <div class="col-lg-9">
                <input placeholder="[{oxmultilang ident="FCPO_BANK_BIC"}]" class="form-control" autocomplete="off"
                       type="text" size="20" maxlength="64" name="dynvalue[fcpo_ou_bic]"
