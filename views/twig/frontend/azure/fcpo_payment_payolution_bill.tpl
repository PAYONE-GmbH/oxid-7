    ...
    <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
        ...
        <ul class="form fcpo_payolution_bill_form">
            ...
            <li>
                ...
                <input placeholder="[{oxmultilang ident="FCPO_PAYOLUTION_USTID"}]" type="text" size="20" maxlength="64"
            ...
            <li>
                ...
                <input placeholder="[{oxmultilang ident="FCPO_PAYOLUTION_PHONE"}]" type="text" size="20" maxlength="64"
                       name="dynvalue[fcpo_payolution_bill_oxfon]" value="[{$oView->fcpoGetUserValue('oxfon')}]">
            </li>
            [{/if}]
            <li>
