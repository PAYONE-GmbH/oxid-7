    ...
    <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
        <ul class="form fcpo_klarna_form">
            ...
            <li>
                ...
                <input placeholder="[{oxmultilang ident="FCPO_KLV_TELEPHONENUMBER"}]" autocomplete="off" type="text"
                       size="20" maxlength="64" [{if $blKlv}]name="dynvalue[fcpo_klv_fon]"
                       value="[{$dynvalue.fcpo_klv_fon}]" [{else}]name="dynvalue[fcpo_kls_fon]"
                       value="[{$dynvalue.fcpo_kls_fon}]" [{/if}]>
                <div [{if $blKlv}]id="fcpo_klv_fon_invalid" [{else}]id="fcpo_kls_fon_invalid" [{/if}]
            ...
            <li style="width: 850px;">
                ...
                <input placeholder="DD" autocomplete="off" type="text" size="3" maxlength="2"
                       style="width:auto;margin-right:10px;" [{if $blKlv}]name="dynvalue[fcpo_klv_birthday][day]"
                       value="[{$dynvalue.fcpo_klv_birthday.day}]" [{else}]name="dynvalue[fcpo_kls_birthday][day]"
                       value="[{$dynvalue.fcpo_kls_birthday.day}]" [{/if}]>
                <input placeholder="MM" autocomplete="off" type="text" size="3" maxlength="2"
                       style="width:auto;margin-right:10px;" [{if $blKlv}]name="dynvalue[fcpo_klv_birthday][month]"
                       value="[{$dynvalue.fcpo_klv_birthday.month}]" [{else}]name="dynvalue[fcpo_kls_birthday][month]"
                       value="[{$dynvalue.fcpo_kls_birthday.month}]" [{/if}]>
                <input placeholder="YYYY" autocomplete="off" type="text" size="8" maxlength="4"
                       style="width:auto;margin-right:10px;" [{if $blKlv}]name="dynvalue[fcpo_klv_birthday][year]"
                       value="[{$dynvalue.fcpo_klv_birthday.year}]" [{else}]name="dynvalue[fcpo_kls_birthday][year]"
                       value="[{$dynvalue.fcpo_kls_birthday.year}]" [{/if}]> (DD.MM.YYYY)
                <div [{if $blKlv}]id="fcpo_klv_birthday_invalid" [{else}]id="fcpo_kls_birthday_invalid" [{/if}]
                     class="fcpo_check_error">
                    <p class="oxValidateError" style="display: block;">
            ...
            <li>
                ...
                <input placeholder="[{oxmultilang ident="FCPO_KLV_ADDINFO"}]" autocomplete="off" type="text" size="20"
                       maxlength="64" [{if $blKlv}]name="dynvalue[fcpo_klv_addinfo]"
                       value="[{$dynvalue.fcpo_klv_addinfo}]" [{else}]name="dynvalue[fcpo_kls_addinfo]"
                       value="[{$dynvalue.fcpo_kls_addinfo}]" [{/if}]>
                <div [{if $blKlv}]id="fcpo_klv_addinfo_invalid" [{else}]id="fcpo_kls_addinfo_invalid" [{/if}]
                     class="fcpo_check_error">
                    <p class="oxValidateError" style="display: block;">
            ...
            <li>
                ...
                <input placeholder="[{oxmultilang ident="FCPO_KLV_ADDINFO_DEL"}]" autocomplete="off" type="text"
                       size="20" maxlength="64" [{if $blKlv}]name="dynvalue[fcpo_klv_del_addinfo]"
                       value="[{$dynvalue.fcpo_klv_del_addinfo}]" [{else}]name="dynvalue[fcpo_kls_del_addinfo]"
                       value="[{$dynvalue.fcpo_kls_del_addinfo}]" [{/if}]>
                <div [{if $blKlv}]id="fcpo_klv_del_addinfo_invalid" [{else}]id="fcpo_kls_del_addinfo_invalid" [{/if}]
                     class="fcpo_check_error">
                    <p class="oxValidateError" style="display: block;">
                        [{oxmultilang ident="FCPO_KLV_ADDINFO_INVALID"}]
                    </p>
            ...
            <li>
                ...
                [{if $blKlv}]
                [{include file="form/fieldset/salutation.html.twig" name="dynvalue[fcpo_klv_sal]" value=$dynvalue.fcpo_klv_sal}]
                [{else}]
                [{include file="form/fieldset/salutation.html.twig" name="dynvalue[fcpo_kls_sal]" value=$dynvalue.fcpo_kls_sal}]
                [{/if}]
            </li>
            [{/if}]
            ...
            <li>
                ...
                <input placeholder="[{oxmultilang ident="FCPO_KLV_PERSONALID"}]" autocomplete="off" type="text"
                       size="20" maxlength="64" [{if $blKlv}]name="dynvalue[fcpo_klv_personalid]"
                       value="[{$dynvalue.fcpo_klv_personalid}]" [{else}]name="dynvalue[fcpo_kls_personalid]"
                       value="[{$dynvalue.fcpo_kls_personalid}]" [{/if}]>
                <div [{if $blKlv}]id="fcpo_klv_personalid_invalid" [{else}]id="fcpo_kls_personalid_invalid" [{/if}]
                     class="fcpo_check_error">
                    <p class="oxValidateError" style="display: block;">
            ...
            <br>
                ...
                <input type="checkbox" name="dynvalue[fcpo_klv_confirm]" value="true"
                       [{if $dynvalue.fcpo_klv_confirm}]checked[{/if}]>
                    [{else}]
                ...
                <input type="checkbox" name="dynvalue[fcpo_kls_confirm]" value="true"
                       [{if $dynvalue.fcpo_kls_confirm}]checked[{/if}]>
                    [{/if}]
                </div>
                ...
                <div [{if $blKlv}]id="fcpo_klv_confirmation_missing" [{else}]id="fcpo_kls_confirmation_missing" [{/if}]
                     class="fcpo_check_error">
