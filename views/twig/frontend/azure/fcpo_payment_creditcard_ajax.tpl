            ...
            <ul class="form fcpo_kk_form">
                ...
                <li>
                    ...
                    <select name="dynvalue[fcpo_kktype]"
                            [{if $oView->getMaestroUK()}]onchange="fcCheckType(this); return false;" [{/if}]>
                        [{foreach from=$aFcPoCCPaymentMetaData item="oFcPoCCPaymentMetaData"}]
                ...
                <li>
                    ...
                    <input placeholder="[{oxmultilang ident="FCPO_NUMBER"}]" autocomplete="off" type="text"
                ...
                <li class="form-group">
                    ...
                    >
                    <p style="display: block; padding: 5px 0 5px 150px">
                        [{oxmultilang ident="FCPO_CC_CARDHOLDER_HELPTEXT"}]</p>
                ...
                <li>
                    ...
                    <input placeholder="[{oxmultilang ident="FCPO_CARD_SECURITY_CODE"}]" autocomplete="off" type="text"
                           class="payment_text" size="20" maxlength="64" name="dynvalue[fcpo_kkpruef]"
                ...
                <li id="fcpo_kkcsn_row" style="display: none;">
                    ...
                    <input placeholder="[{oxmultilang ident="FCPO_CARDSEQUENCENUMBER"}]" autocomplete="off" type="text"
                           class="payment_text" size="20" maxlength="64" name="dynvalue[fcpo_kkcsn]"
