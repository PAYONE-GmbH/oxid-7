    ...
    <dl>
        ...
        <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
            ...
            <div class="form-group fcpo_klv_fon">
                ...
                <div class="col-lg-9">
                    <input placeholder="[{oxmultilang ident="FCPO_KLV_TELEPHONENUMBER"}]" class="form-control"
                           autocomplete="off" type="text" size="20" maxlength="64"
                           [{if $blKlv}]name="dynvalue[fcpo_klv_fon]" value="[{$dynvalue.fcpo_klv_fon}]"
                           [{else}]name="dynvalue[fcpo_kls_fon]" value="[{$dynvalue.fcpo_kls_fon}]" [{/if}]>
            ...
            <div class="form-group fcpo_klv_birthday">
                ...
                <div class="col-lg-3">
                    <input class="form-control" placeholder="YYYY" autocomplete="off" type="text" size="8" maxlength="4"
                           ...
                           value="[{$dynvalue.fcpo_kls_birthday.year}]" [{/if}]>
                </div>
                <div class="col-lg-9">
            ...
            <div class="form-group fcpo_klv_addinfo">
                ...
                <div class="col-lg-9">
                    <input placeholder="[{oxmultilang ident="FCPO_KLV_ADDINFO"}]" class="form-control"
                           autocomplete="off" type="text" size="20" maxlength="64"
                           [{if $blKlv}]name="dynvalue[fcpo_klv_addinfo]" value="[{$dynvalue.fcpo_klv_addinfo}]"
                           [{else}]name="dynvalue[fcpo_kls_addinfo]" value="[{$dynvalue.fcpo_kls_addinfo}]" [{/if}]>
            ...
            <div class="form-group fcpo_klv_del_addinfo">
                ...
                <div class="col-lg-9">
                    <input placeholder="[{oxmultilang ident="FCPO_KLV_ADDINFO_DEL"}]" class="form-control"
                           autocomplete="off" type="text" size="20" maxlength="64"
                           ...
                           [{/if}]>
                    <div [{if $blKlv}]id="fcpo_klv_del_addinfo_invalid" [{else}]id="fcpo_kls_del_addinfo_invalid"
                         [{/if}] class="fcpo_check_error">
                                <span class="help-block">
                                    <ul role="alert" class="list-unstyled text-danger">
                                        <li>[{oxmultilang ident="FCPO_KLV_ADDINFO_INVALID"}]</li>
                                    </ul>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-2">
                    [{if $blKlv}]
                    [{include file="form/fieldset/salutation.html.twig" name="dynvalue[fcpo_klv_sal]" value=$dynvalue.fcpo_klv_sal class="form-control selectpicker show-tick"}]
                    [{else}]
                    [{include file="form/fieldset/salutation.html.twig" name="dynvalue[fcpo_kls_sal]" value=$dynvalue.fcpo_kls_sal class="form-control selectpicker show-tick"}]
                    [{/if}]
                </div>
            </div>
            [{/if}]
            ...
            <div class="form-group fcpo_klv_personalid">
                ...
                <div class="col-lg-9">
                    <input placeholder="[{oxmultilang ident="FCPO_KLV_PERSONALID"}]" class="form-control"
                           autocomplete="off" type="text" size="20" maxlength="64"
            ...
            <div class="form-group fcpo_confirm">
                ...
                <input class="form-control checkbox" type="checkbox" name="dynvalue[fcpo_klv_confirm]" value="true"
                       [{if $dynvalue.fcpo_klv_confirm}]checked[{/if}]>
                    [{else}]
                <input type="hidden" name="dynvalue[fcpo_kls_confirm]" value="false">
                <input class="form-control checkbox" type="checkbox" name="dynvalue[fcpo_kls_confirm]" value="true"
                ...
                <div class="col-lg-9">
                    <div [{if $blKlv}]id="fcpo_klv_confirmation_missing" [{else}]id="fcpo_kls_confirmation_missing"
                         [{/if}] class="fcpo_check_error">
                            <span class="help-block">
                                <ul role="alert" class="list-unstyled text-danger">
