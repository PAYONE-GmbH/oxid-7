        ...
        <dl id="fcpoCreditcard" style="display:none;">
            ...
            <input type="hidden" name="[{$oFcPoCCPaymentMetaData->sOperationModeName}]"
                ...
                <div class="form-group fcpo_kkcardholder">
                    <label id="fcpo_cc_cardholder_label" id="fcpo_cc_cardholder_label"
                ...
                <div class="form-group fcpo_kkexpire">
                    <label class="req control-label col-xs-12 col-lg-3">[{oxmultilang ident="FCPO_VALID_UNTIL"}
                        ]:</label>
                ...
                <div class="form-group fcpo_kkpruef">
                    ...
                    <div class="col-lg-9">
                        <input placeholder="[{oxmultilang ident="FCPO_CARD_SECURITY_CODE"}]" autocomplete="off"
                ...
                <div class="form-group" id="fcpo_kkcsn_row" style="display: none;">
                    ...
                    <div class="col-lg-9">
                        <input placeholder="[{oxmultilang ident="FCPO_CARDSEQUENCENUMBER"}]" autocomplete="off"
