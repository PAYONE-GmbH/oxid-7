            ...
            <div class="fcCol fcCol-1">
                <div class="content">
                    <p id="payolution_installment_availibility_headline" class="payolution_installment_box_headline">1.
                        [{oxmultilang ident="FCPO_PAYOLUTION_CHECK_INSTALLMENT_AVAILABILITY"}]</p>
                    <p id="payolution_installment_availibility_subtitle" class="payolution_installment_box_subtitle">
                        [{oxmultilang ident="FCPO_PAYOLUTION_BIRTHDATE"}]:</p>
                    ...
                    <p id="payolution_installment_availibility_body" class="payolution_installment_box_body">
                        <select name="dynvalue[fcpo_payolution_installment_birthdate_day]">
                            ...
                            <option value="[{$sDay}]"
                                    [{if $sDay == $oView->fcpoGetBirthdayField('day')}]selected[{/if}]>[{$sDay}]
                            </option>
                            [{/foreach}]
                        </select>
                        &nbsp;
                        ...
                        <select name="dynvalue[fcpo_payolution_installment_birthdate_year]">
                            ...
                            <option value="[{$sYear}]"
                                    [{if $sYear == $oView->fcpoGetBirthdayField('year')}]selected[{/if}]>[{$sYear}]
                            </option>
                            [{/foreach}]
                        </select>
                        <br>
                        ...
                        ] <a href='[{$oView->fcpoGetPayolutionAgreementLink()}]'
                             class="lightview fcpoPayolutionAgreeRed" data-lightview-type="iframe"
                             data-lightview-options="width: 800, height: 600, viewport: 'scale',background: { color: '#fff', opacity: 1 },skin: 'light'">[{oxmultilang ident="FCPO_PAYOLUTION_AGREE"}
                            ]</a> [{oxmultilang ident="FCPO_PAYOLUTION_AGREEMENT_PART_2"}]
                    </p>
                </div>
                <input type="button" id="payolution_installment_check_availability" class="fcBTN-bot"
                       value="[{oxmultilang ident="FCPO_PAYOLUTION_CHECK_INSTALLMENT_AVAILABILITY"}]">
            </div>
                ...
                <div id="payolution_installment_calculation_selection">
                    <div class="content">
                        <p id="payolution_installment_calculation_headline" class="payolution_installment_box_headline">
                            2. [{oxmultilang ident="FCPO_PAYOLUTION_INSTALLMENT_SELECTION"}]</p>
                        <p id="payolution_installment_calculation_headline" class="payolution_installment_box_subtitle">
                            [{oxmultilang ident="FCPO_PAYOLUTION_SELECT_INSTALLMENT"}]</p>
                        ...
                        <p id="payolution_installment_calculation_greeter" class="payolution_message_notifiation">
                            [{oxmultilang ident="FCPO_PAYOLUTION_PLEASE_CHECK_AVAILABLILITY"}]</p>
                    </div>
                </div>
            </div>
            <div class="fcCol fcCol-3">
                <div class="content">
                    <p id="payolution_installment_overview_headline" class="payolution_installment_box_headline">3.
                        [{oxmultilang ident="FCPO_PAYOLUTION_INSTALLMENT_SUMMARY_AND_ACCOUNT"}]</p>
                    ...
                    <div id="payolution_installment_overview_account_info">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span id="payolution_financing_sum">[{oxmultilang ident="FCPO_PAYOLUTION_INSTALLMENT_NOT_YET_SELECTED"}]</span>
                                    [{$currency->sign}]
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <span id="payolution_sum_interest_rate">[{oxmultilang ident="FCPO_PAYOLUTION_INSTALLMENT_NOT_YET_SELECTED"}]</span>
                                    %
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <span id="payolution_sum_eff_interest_rate">[{oxmultilang ident="FCPO_PAYOLUTION_INSTALLMENT_NOT_YET_SELECTED"}]</span>
                                    %
                                </td>
                            </tr>
                            <tr>
                                <td><strong>[{oxmultilang ident="FCPO_PAYOLUTION_INSTALLMENT_MONTHLY_RATES"}]</strong>
                                </td>
                                <td><span id="payolution_sum_monthly_rate"
                                          class="fcpoPayolutionAgreeRed">[{oxmultilang ident="FCPO_PAYOLUTION_INSTALLMENT_NOT_YET_SELECTED"}]</span>
                                    [{$currency->sign}]
                                </td>
                            </tr>
                        </table>
                    ...
                    <p>
                        ...
                        <input placeholder="[{oxmultilang ident="FCPO_PAYOLUTION_ACCOUNTHOLDER"}]" autocomplete="off"
                    ...
                    <p>
                        ...
                        <input placeholder="[{oxmultilang ident="FCPO_BANK_IBAN"}]" autocomplete="off" type="text"
                    ...
                    <p>
                        ...
                        <input placeholder="[{oxmultilang ident="FCPO_BANK_BIC"}]" autocomplete="off" type="text"
