    ...
    <dl>
        ...
        <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}] activePayment[{else}]payment-option[{/if}]">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-2">
                    [{if $blKlv}]
                    [{include file="form/fieldset/salutation.html.twig" name="dynvalue[fcpo_klv_sal]" value=$dynvalue.fcpo_klv_sal class="form-control show-tick"}]
                    [{else}]
                    [{include file="form/fieldset/salutation.html.twig" name="dynvalue[fcpo_kls_sal]" value=$dynvalue.fcpo_kls_sal class="form-control show-tick"}]
                    [{/if}]
                </div>
            </div>
            [{/if}]
