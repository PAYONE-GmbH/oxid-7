[{if $oView->fcpoRatePayAllowed('fcporp_debitnote')}]
    <dl>
        ...
        <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
            ...
            <input type="hidden" name="dynvalue[fcporp_debitnote_device_fingerprint]"
            ...
            <div class="form-group fcporp_debitnote_ustid">
                ...
                <div class="col-lg-9">
                    <input placeholder="[{oxmultilang ident="FCPO_RATEPAY_USTID"}]" class="form-control" type="text"
                           size="20" maxlength="64" name="dynvalue[fcporp_debitnote_ustid]"
            ...
            <div class="form-group fcporp_debitnote_fon">
                ...
                <div class="col-lg-9">
                    <input placeholder="[{oxmultilang ident="FCPO_RATEPAY_FON"}]" class="form-control" type="text"
                           size="20" maxlength="64" name="dynvalue[fcporp_debitnote_fon]"
            ...
            <div class="form-group fcpo_ratepay_debitnote_iban">
                ...
                <div class="col-lg-9">
                    <input placeholder="[{oxmultilang ident="FCPO_BANK_IBAN"}]"
                           class="form-control js-oxValidate js-oxValidate_notEmpty" type="text" size="20"
                           maxlength="64" name="dynvalue[fcpo_ratepay_debitnote_iban]"
                           value="[{$dynvalue.fcpo_ratepay_debitnote_iban}]"
                           onkeyup="fcHandleDebitInputs();return false;" required="required">
            ...
            <div class="form-group fcpo_ratepay_debitnote_bic">
                ...
                <div class="col-lg-9">
                    <input class="form-control js-oxValidate js-oxValidate_notEmpty" autocomplete="off" type="text"
            ...
            <div class="alert alert-info col-lg-offset-3 desc">
                <input name="dynvalue[fcpo_ratepay_debitnote_agreed]" value="agreed" type="checkbox">
                [{oxmultilang ident="FCPO_RATEPAY_ADD_TERMS1"}] <a href='[{$oView->fcpoGetRatepayAgreementLink()}]'
                                                                   class='lightview fcpoRatepayAgreeRed'
                                                                   data-lightview-type="iframe"
                                                                   data-lightview-options="width: 800, height: 600, viewport: 'scale',background: { color: '#fff', opacity: 1 },skin: 'light'">[{oxmultilang ident="FCPO_RATEPAY_ADD_TERMS2"}
                    ]</a> [{oxmultilang ident="FCPO_RATEPAY_ADD_TERMS3"}] <a
                        href='[{$oView->fcpoGetRatepayPrivacyLink()}]' class='lightview fcpoRatepayAgreeRed'
                        data-lightview-type="iframe"
                        data-lightview-options="width: 800, height: 600, viewport: 'scale',background: { color: '#fff', opacity: 1 },skin: 'light'">[{oxmultilang ident="FCPO_RATEPAY_ADD_TERMS4"}
                    ]</a> [{oxmultilang ident="FCPO_RATEPAY_ADD_TERMS5"}]
            </div>
            ...
            <div class="alert alert-info col-lg-offset-3 desc">
                <input name="dynvalue[fcpo_ratepay_debitnote_sepa_agreed]" value="agreed"
                       type="checkbox">&nbsp;[{oxmultilang ident="FCPO_RATEPAY_SEPA_AGREE"}]
            </div>
