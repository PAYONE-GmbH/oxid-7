<dl>
    ...
    <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}] activePayment[{else}]payment-option[{/if}]">
        ...
        <div class="form-group fcpo_payolution_bill_oxustid">
            ...
            <div class="col-lg-9">
                <input placeholder="[{oxmultilang ident="FCPO_PAYOLUTION_USTID"}]" class="form-control" type="text"
                       size="20" maxlength="64" name="dynvalue[fcpo_payolution_bill_oxustid]"
        ...
        <div class="form-group fcpo_payolution_bill_oxfon">
            ...
            <div class="col-lg-9">
                <input placeholder="[{oxmultilang ident="FCPO_PAYOLUTION_PHONE"}]" class="form-control" type="text"
                       size="20" maxlength="64" name="dynvalue[fcpo_payolution_bill_oxfon]"
