        ...
        <dl id="fcpoCreditcard" style="display:none;">
            ...
            <input type="hidden" name="[{$oFcPoCCPaymentMetaData->sOperationModeName}]"
                ...
                <div class="form-group fcpo_kktype">
                    <label for="cardtype" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_CREDITCARD"}
                        ]:</label>
                    <div class="col-lg-9">
                        <select id="cardtype" name="dynvalue[fcpo_kktype]" class="form-control selectpicker"
                                required="required">
                            <option value="V" data-cardtype="none">[{oxmultilang ident="FCPO_CREDITCARD_CHOOSE"}]
                            </option>
                            [{foreach from=$aFcPoCCPaymentMetaData item="oFcPoCCPaymentMetaData"}]
                            <option value="[{$oFcPoCCPaymentMetaData->sPaymentTag}]"
                                    data-cardtype="[{$oFcPoCCPaymentMetaData->sPaymentTag}]"
                                    [{if $oFcPoCCPaymentMetaData->blSelected}]selected[{/if}]>
                ...
                <div class="form-group fcpo_kknumber">
                    <label for="cardpanInput" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_NUMBER"}
                        ]:</label>
                    <div class="col-lg-9">
                ...
                <div class="form-group fcpo_kkpruef">
                    <label for="cvcInput"
                           class="req control-label col-lg-3">[{oxmultilang ident="FCPO_CARD_SECURITY_CODE"}]:</label>
                    <div class="col-lg-9">
                ...
                <div class="form-group fcpo_kkexpire">
                    <label for="expireInput" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_VALID_UNTIL"}
                        ]:</label>
                    <div class="col-lg-9">
                ...
                <div class="form-group fcpo_kkcardholder">
                    <label for="fcpo_cc_cardholder" id="fcpo_cc_cardholder_label"
                           class="req control-label col-lg-3">[{oxmultilang ident="FCPO_CC_CARDHOLDER"}]:</label>
                    <div class="col-lg-9">
                ...
                <div class="form-group">
                    <div class="col-lg-9 col-lg-push-3">
                        <div id="errorCVC" style="display:none;" class="alert-danger">
                            [{oxmultilang ident="FCPO_CC_HOSTED_ERROR_CVC"}]
                        </div>
                        <div id="errorCardType" style="display:none;" class="alert-danger">
                            [{oxmultilang ident="FCPO_CC_HOSTED_ERROR_CARDTYPE"}]
                        </div>
                        <div id="errorIncomplete" style="display:none;" class="alert-danger">
                            [{oxmultilang ident="FCPO_CC_HOSTED_ERROR_INCOMPLETE"}]
                        </div>
                    </div>
                </div>

                [{oxid_include_dynamic file=$oViewConf->fcpoGetAbsModuleTemplateFrontendPath('fcpo_payment_creditcard_script.html.twig')}
                ]
