...
class FcPayOneEvents
{
     ...
     * @var array
     */
    public static $_aRemovedPaymentMethods = ['fcpoyapital', 
    'fcpocommerzfinanz', 
    ...
    public static $aPaymentMethods = ['fcpoinvoice' => 'Rechnung', 
    ...
    'FCPOTXID', self::$sQueryAlterOxorderTxid);
        self::addColumnIfNotExists('oxorder', 
    'FCPOREFNR', self::$sQueryAlterOxorderRefNr);
        self::addColumnIfNotExists('oxorder', 
    'FCPOAUTHMODE', self::$sQueryAlterOxorderAuthMode);
        self::addColumnIfNotExists('oxorder', 
    'FCPOMODE', self::$sQueryAlterOxorderMode);

        self::addColumnIfNotExists('oxorder', 
    'FCPODELCOSTDEBITED', self::$sQueryAlterOxorderDelcostDebited);
        self::addColumnIfNotExists('oxorder', 
    'FCPOPAYCOSTDEBITED', self::$sQueryAlterOxorderPaycostDebited);
        self::addColumnIfNotExists('oxorder', 
    'FCPOWRAPCOSTDEBITED', self::$sQueryAlterOxorderWrapcostDebited);
        self::addColumnIfNotExists('oxorder', 
    'FCPOGIFTCARDCOSTDEBITED', self::$sQueryAlterOxorderGiftcardcostDebited);
        self::addColumnIfNotExists('oxorder', 
    'FCPOVOUCHERDISCOUNTDEBITED', self::$sQueryAlterOxorderVoucherdiscountDebited);
        self::addColumnIfNotExists('oxorder', 
    'FCPODISCOUNTDEBITED', self::$sQueryAlterOxorderDiscountDebited);
        self::addColumnIfNotExists('oxorder', 
    'FCPOORDERNOTCHECKED', self::$sQueryAlterOxorderNotChecked);
        self::addColumnIfNotExists('oxorder', 
    'FCPOWORKORDERID', self::$sQueryAlterOxorderWorkOrderId);
        self::addColumnIfNotExists('oxorder', 
    'FCPOCLEARINGREFERENCE', self::$sQueryAlterOxorderClearingReference);
        self::addColumnIfNotExists('oxorder', 
    'FCPOPROFILEIDENT', self::$sQueryAlterOxorderProfileIdent);

        self::addColumnIfNotExists('oxorderarticles', 
    'FCPOCAPTUREDAMOUNT', self::$sQueryAlterOxorderarticlesCapturedAmount);
        self::addColumnIfNotExists('oxorderarticles', 
    'FCPODEBITEDAMOUNT', self::$sQueryAlterOxorderarticlesDebitedAmount);

        self::addColumnIfNotExists('oxpayments', 
    'FCPOISPAYONE', self::$sQueryAlterOxpaymentsIsPayone);
        self::addColumnIfNotExists('oxpayments', 
    'FCPOAUTHMODE', self::$sQueryAlterOxpaymentsAuthMode);
        self::addColumnIfNotExists('oxpayments', 
    'FCPOLIVEMODE', self::$sQueryAlterOxpaymentsLiveMode);

        self::addColumnIfNotExists('oxuser', 
    'FCPOBONICHECKDATE', self::$sQueryAlterOxuser);
        self::addColumnIfNotExists('oxuser', 
    'FCPOPERSONALID', self::$sQueryAlterOxuserPersonalId);
        self::addColumnIfNotExists('oxuser', 
    'FCPOCURRMALUS', self::$sQueryAlterOxuserCurrentMalus);
        self::addColumnIfNotExists('oxuser', 
    'FCPOREALBONI', self::$sQueryAlterOxuserRealBoni);

        self::addColumnIfNotExists('fcporefnr', 
    'FCPO_REFPREFIX', self::$sQueryAlterFcporefnr);

        self::addColumnIfNotExists('fcpotransactionstatus', 
    'FCPO_CLEARING_BANKACCOUNTHOLDER', self::$sQueryAlterTxStatusClearing1);
        self::addColumnIfNotExists('fcpotransactionstatus', 
    'FCPO_CLEARING_BANKACCOUNT', self::$sQueryAlterTxStatusClearing2);
        self::addColumnIfNotExists('fcpotransactionstatus', 
    'FCPO_CLEARING_BANKCODE', self::$sQueryAlterTxStatusClearing3);
        self::addColumnIfNotExists('fcpotransactionstatus', 
    'FCPO_CLEARING_BANKNAME', self::$sQueryAlterTxStatusClearing4);
        self::addColumnIfNotExists('fcpotransactionstatus', 
    'FCPO_CLEARING_BANKBIC', self::$sQueryAlterTxStatusClearing5);
        self::addColumnIfNotExists('fcpotransactionstatus', 
    'FCPO_CLEARING_BANKIBAN', self::$sQueryAlterTxStatusClearing6);
        self::addColumnIfNotExists('fcpotransactionstatus', 
    'FCPO_CLEARING_LEGALNOTE', self::$sQueryAlterTxStatusClearing7);
        self::addColumnIfNotExists('fcpotransactionstatus', 
    'FCPO_CLEARING_DUEDATE', self::$sQueryAlterTxStatusClearing8);
        self::addColumnIfNotExists('fcpotransactionstatus', 
    'FCPO_CLEARING_REFERENCE', self::$sQueryAlterTxStatusClearing9);
        self::addColumnIfNotExists('fcpotransactionstatus', 
    'FCPO_CLEARING_INSTRUCTIONNOTE', self::$sQueryAlterTxStatusClearing10);
        self::addColumnIfNotExists('fcpotransactionstatus', 
    'FCPO_FORWARD_STATE', self::$sQueryAlterFcpoTransactionStatusForwardState);
        self::addColumnIfNotExists('fcpotransactionstatus', 
    'FCPO_FORWARD_TRIES', self::$sQueryAlterFcpoTransactionStatusForwardTries);

        self::addColumnIfNotExists('fcpoklarnacampaigns', 
    'FCPO_CAMPAIGN_LANGUAGE', self::$sQueryAlterCampaign1);
        self::addColumnIfNotExists('fcpoklarnacampaigns', 
    'FCPO_CAMPAIGN_CURRENCY', self::$sQueryAlterCampaign2);

        self::addColumnIfNotExists('fcpopdfmandates', 
    'OXTIMESTAMP', self::$sQueryAlterFcpopdfmandatesOxtimestamp);

        //COPY DATA FROM OLD FCPO_TIMESTAMP COLUMN TO OXTIMESTAMP
        self::copyDataFromOldColumnIfExists('fcporequestlog', 
    'FCPO_TIMESTAMP', 
    'OXTIMESTAMP', self::$sQueryFcporequestlogCopyTimestampData);
        self::copyDataFromOldColumnIfExists('fcpotransactionstatus', 
    'FCPO_TIMESTAMP', 
    'OXTIMESTAMP', self::$sQueryFcpotransactionstatusCopyTimestampData);
     ...
     */
    public static function addTableIfNotExists($sTableName, $sQuery): bool
    {
     ...
     */
    public static function copyDataFromOldColumnIfExists($sTableName, $oldColumnName, $newColumnName, $copyDataQuery): bool
    {
     ...
     * @return boolean true or false
     */
    public static function dropColumnIfItAndReplacementExist($sTable, $oldColumn, $replacementColumn): bool
    {
     ...
     * @return boolean true or false
     */
    public static function changeColumnNameIfWrong($sTableName, $sColumnName, $sQuery): bool
    {
     ...
     * @return boolean true or false
     */
    public static function changeColumnTypeIfWrong($sTableName, $sColumnName, $sExpectedType, $sQuery): bool
    {
        $sCheckQuery = "
            SHOW COLUMNS 
            FROM {$sTableName} 
    ...
    {
        foreach (self::$_aRemovedPaymentMethods as $_aRemovedPaymentMethod) {
            self::dropRowIfExists("oxpayments", ['OXID' => $_aRemovedPaymentMethod], "DELETE FROM oxpayments WHERE OXID='" . $_aRemovedPaymentMethod . "'");
            self::dropRowIfExists("oxobject2group", ['OXOBJECTID' => $_aRemovedPaymentMethod], "DELETE FROM oxobject2group WHERE oxobjectid='" . $_aRemovedPaymentMethod . "'");
            self::dropRowIfExists("oxobject2payment", ['OXPAYMENTID' => $_aRemovedPaymentMethod], "DELETE FROM oxobject2payment WHERE oxpaymentid='" . $_aRemovedPaymentMethod . "'");
        }
    }
    ...
    public static function isUnderVersion($sMaxVersion): bool
    {
        ...
        return version_compare($sCurrVersion, $sMaxVersion, '<');
    }
     ...
     * @return boolean true or false
     */
    public static function isOverVersion($sMinVersion, $blEqualOrGreater = false): bool
    {
        $sCompareOperator = ($blEqualOrGreater) ? '>=' : '>';
        $sCurrVersion = self::getCurrentVersion();

        return version_compare($sCurrVersion, $sMinVersion, $sCompareOperator);
    }
    ...
    public static function isBetweenVersions($sMinVersion, $sMaxVersion): bool
    {
        ...
        return (bool) isUnderVersion($sMaxVersion);
    }
     ...
     * @return boolean true or false
     */
    public static function copyFile($sSource, $sDestination): void
    {
     ...
     */
    public static function deleteFileIfExists($sFile): void
    {
